...
sys.path.insert(0, os.path.abspath("../numpy_utils"))
...
# of the sidebar.
"""
html_logo = "images/numpy_utils.png"
"""
...
man_pages = [("index", "numpy_utils", "numpy_utils Documentation", [author], 1)]
